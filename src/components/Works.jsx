    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          through real-world projects. Here, you'll find a curated selection of
          my work, each project briefly described with direct links to their
          GitHub code repositories and live demos. These projects highlight my
          ability to tackle complex problems, adeptly handle various
          technologies, and manage them with efficiency and professionalism.
        </motion.p>
      </div>
