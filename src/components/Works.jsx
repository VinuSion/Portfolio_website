          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            {/*
              <div
                ...
                className="bg-gradient-to-r from-[#0d3c36] to-[#051614] w-10 h-10 rounded-full flex justify-center items-center cursor-pointer mr-3"
              >
                <svg
            ...
            */}
            <div
              ...
              className="bg-gradient-to-r from-[#0d3c36] to-[#051614] w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
            >
              <img
                src={github}
                alt={github}
